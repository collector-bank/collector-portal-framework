...
const hiddenContent = (
    <svg fill={'#f4e8ff'} height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const Input = forwardRef<HTMLInputElement, InputProps>(({ label, error, warning, multiline, description, hideNShow, onBlur, ...rest }, ref) => {
    const id = uniqid();
